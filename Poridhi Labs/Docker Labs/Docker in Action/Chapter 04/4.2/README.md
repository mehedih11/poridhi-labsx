...
![](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.2/images/linux_file_tree.png)
...
![](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.2/images/7.png)
...
2. **Create a custom NGINX configuration file**:
   ...
   ![](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.2/images/1.png)
...
2. **Run the container with bind mounts**:
   ...
   ![alt text](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.2/images/image-1.png)
...
1. **Access the NGINX web server**:
   ...
   ```sh
    ...
    ![alt text](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.2/images/image-2.png)
...
2. **Check the logs**:
   - Run the command on the host to see the access logs generated by NGINX. These logs are written to the `example.log` file on the host due to the **bind mount**.
    ...
    cat ~/example.log
    ```
    ![](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.2/images/4.png)
...
1. **Remove the existing container**:
   ...
   ![alt text](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.2/images/image-3.png)
...
2. **Run the container with a read-only bind mount**:
   ...
   ![alt text](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.2/images/image-4.png)
...
![alt text](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.2/images/image-5.png)
