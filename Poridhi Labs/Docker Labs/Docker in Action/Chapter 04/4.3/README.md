...
![](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.3/images/7.png)
...
docker run --rm \
    ...
    alpine:latest -v
```
![alt text](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.3/images/image.png)
...
- Run the Docker container, ensuring that the tmpfs mount is properly configured.
    ...
    ```
    ![alt text](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.3/images/image-2.png)
    ...
    docker run --rm -d \
        ...
        my_microservice
    ```
    ![alt text](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.3/images/image-4.png)
...
1. **Verify Mount Configuration**: When running the Docker container, ensure that the tmpfs mount is configured correctly. we can do this by inspecting the container's mounts:
    ...
    ![](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.3/images/4.png)
...
2. **Check File Storage Location**: Confirm that sensitive data is being stored within the tmpfs-mounted directory. We can do this by examining the files created or accessed by the container.
    ...
    ```
    ![alt text](https://github.com/mehedih11/poridhi-labsx/raw/main/Poridhi%20Labs/Docker%20Labs/Docker%20in%20Action/Chapter%2004/4.3/images/image-3.png)
