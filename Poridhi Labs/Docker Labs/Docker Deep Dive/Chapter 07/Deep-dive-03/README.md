...
- **`docker stop`**: Sends a `SIGTERM` signal first, allowing the process to clean up before termination. If the process doesn't terminate within a specified timeout (default 10 seconds), Docker sends a `SIGKILL` signal to forcefully stop the process.
   ...
   ![alt text](https://raw.githubusercontent.com/mehedih11/poridhi-labsx/refs/heads/main/Poridhi%20Labs/Docker%20Labs/Docker%20Deep%20Dive/Chapter%2007/Deep-dive-03/images/image.png)

- **`docker kill`**: Sends a `SIGKILL` signal immediately, terminating the process without allowing any clean-up.

   ![alt text](https://raw.githubusercontent.com/mehedih11/poridhi-labsx/refs/heads/main/Poridhi%20Labs/Docker%20Labs/Docker%20Deep%20Dive/Chapter%2007/Deep-dive-03/images/image-1.png)
...
![alt text](https://raw.githubusercontent.com/mehedih11/poridhi-labsx/refs/heads/main/Poridhi%20Labs/Docker%20Labs/Docker%20Deep%20Dive/Chapter%2007/Deep-dive-03/images/stop-kill-01.PNG)
...
![alt text](https://raw.githubusercontent.com/mehedih11/poridhi-labsx/refs/heads/main/Poridhi%20Labs/Docker%20Labs/Docker%20Deep%20Dive/Chapter%2007/Deep-dive-03/images/stop-kill-02.PNG)
