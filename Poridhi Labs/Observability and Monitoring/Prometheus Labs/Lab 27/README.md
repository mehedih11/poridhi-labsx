...
![](https://raw.githubusercontent.com/mehedih11/poridhi-labsx/f3ae6c4eae9a4fb5c77310025477e50cfac74576/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2027/images/k8s.svg)
...
4. Verify the CRDs: 
   ...
   ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2027/images/image-2.png?raw=true)
...
1. Check if the service monitor is active:
   ...
   ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2027/images/image-1.png?raw=true)

2. Access the Prometheus dashboard and confirm the target is listed under the `Targets` section.

   ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2027/images/image.png?raw=true)
...
3. Query the `node-api` job:
   ...
   ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2027/images/image-3.png?raw=true)
