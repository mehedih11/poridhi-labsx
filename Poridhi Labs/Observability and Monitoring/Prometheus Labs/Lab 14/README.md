...
![alt text](https://raw.githubusercontent.com/mehedih11/poridhi-labsx/986c30528324f6cbcb24f08a34d155a8fcdb6582/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2014/images/logo.svg)
...
3. **Check Prometheus targets:**
   ...
   -  Click on the **"Status"** tab in the top menu and select **"Targets"** in Prometheus GUI.
      ...
      ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2014/images/9.png?raw=true)
...
- **Basic Query**:
   ...
   http_requests_total
   ```
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2014/images/1.png?raw=true)
...
- **Rate of HTTP Requests**:
   ...
   ```
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2014/images/2.png?raw=true)
...
- **Basic Query**:
   ...
   ```
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2014/images/6.png?raw=true)
...
- **Percentage of `4xx` Client Errors**:
   ...
   ```
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2014/images/7.png?raw=true)
...
- **Basic Query**:
   ...
   page_visits_total
   ```
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2014/images/3.png?raw=true)
...
- **Filter by Specific Page (e.g., `home`)**:
   ...
   ```
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2014/images/4.png?raw=true)
...
- **Rate of Page Visits**:
   ...
   ```
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2014/images/5.png?raw=true)
...
- **Basic Query**:
   ...
   ```
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2014/images/8.png?raw=true)
...
- **Rate of Errors**:
   ...
   ```
   ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2014/images/11.png?raw=true)
...
- **Instantaneous Rate of Errors**:
   ...
   ```
   ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2014/images/12.png?raw=true)
