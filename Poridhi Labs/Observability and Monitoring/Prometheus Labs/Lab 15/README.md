...
![alt text](https://raw.githubusercontent.com/mehedih11/poridhi-labsx/986c30528324f6cbcb24f08a34d155a8fcdb6582/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2015/images/logo.svg)
...
3. **Check Prometheus targets:**
   ...
   -  Click on the **"Status"** tab in the top menu and select **"Targets"** in Prometheus GUI.
      ...
      ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2015/images/9.png?raw=true)
...
- **Basic Query**:
   ...
   ```
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2015/images/21.png?raw=true)
...
- **Average Latency Over Time**:
   ...
   ```
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2015/images/22.png?raw=true)
...
- **Maximum Latency Observed**:
   ...
   ```
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2015/images/23.png?raw=true)
