...
![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2019/images/app%20instrument.svg?raw=true)
...
`<flask-app-lb-url>`.
    ...
    ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2019/images/image-1.png?raw=true)

- Send some `GET` request to the address:
`<flask-app-lb-url>/slow`.

    ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2019/images/image.png?raw=true)
...
2. Check if the target is in `up` state from: *status > target health*
    ...
    ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2019/images/image-2.png?raw=true)
...
1. Request Latency (Histogram):
    ...
    ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2019/images/image-3.png?raw=true)
...
2. Request Latency (Summary):
    ...
    ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2019/images/image-4.png?raw=true)
...
3. Active Requests:
    ...
    ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2019/images/image-5.png?raw=true)
