...
![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2006/images/authentication.svg?raw=true)
...
- Get the `IP` to create a load balancer:
  ...
  ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2006/images/image.png?raw=true)
...
- Access the UI by opening the load balancer URL from browser. Go to *status > target*. We can see that prometheus has only one target and it is prometheus itself. Currently, it doesn't have `node_exporter` as its target to scrape. We have to configure the prometheus to scrape the `node_exporter`. 
  ...
  ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2006/images/image-1.png?raw=true)
...
- Add the following job under the `scrape_configs` section:
  ...
  ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2006/images/image-2.png?raw=true)
...
- **Access/Reload the prometheus UI**
  ...
  ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2006/images/image-3.png?raw=true)
...
- Generate a password hash:
  ...
  ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2006/images/image-4.png?raw=true)
...
![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2006/images/image-5.png?raw=true)
...
In the prometheus UI, we can see that the `node_exporter` in in `down` status with `401 Unauthorized` error:
  ...
  ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2006/images/image-6.png?raw=true)
...
![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2006/images/image-7.png?raw=true)
...
![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2006/images/image-8.png?raw=true)
