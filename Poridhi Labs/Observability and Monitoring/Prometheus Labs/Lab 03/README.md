...
![](https://raw.githubusercontent.com/mehedih11/poridhi-labsx/4eb26939f981054bcdeb8c8f4ab05857fb5cca70/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2003/images/logo.svg)
...
1. **Download Prometheus Binary:**
   - Go to the official Prometheus [download page](https://prometheus.io/download/). Copy the link to the latest release of Prometheus for Linux
      ...
      ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2003/images/new-1.png?raw=true)
...
2. **Extract the Tarball**:
     ...
     ```
     ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2003/images/new-3.png?raw=true)
...
2. **Access the Prometheus Web Interface With Poridhi's LoadBalancer**
   ...
   - Find the `eth0` IP address for the Poridhi's VM currently you are running by using the command:
      ...
      ifconfig
      ```
      ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2003/images/new-10.png?raw=true)
    
   - Go to Poridhi's `LoadBalancer`and Create a `LoadBalancer` with the `eht0` IP and port `9090`.

      ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2003/images/new-11.png?raw=true)
    ...
    -  Click on the **"Status"** tab in the top menu and select **"Targets"** in Prometheus GUI.
       ...
       ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2003/images/new-5.png?raw=true)
...
4. **Check Prometheus Service Status**:
   ...
   ```
     ...
     ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2003/images/new-9.png?raw=true)
...
![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2003/images/new-8.png?raw=true)
