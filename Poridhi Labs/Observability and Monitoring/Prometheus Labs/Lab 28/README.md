...
1. **Navigate to Helm Documentation**  
   Visit the [Helm documentation](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2028/images/https://helm.sh/docs/intro/install/) to view installation instructions for various operating systems.
...
![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2028/images/image.png?raw=true)
...
2. Verify successful creation with:
   ...
   ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2028/images/image-1.png?raw=true)
...
3. Open the Prometheus UI, navigate to `Status > Rules`, and locate the `API` group and `InstanceDown` rule to confirm proper deployment.
    ...
    ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2028/images/image-2.png?raw=true)
...
2. Update the `AlertmanagerConfigSelector` section in the `values.yaml` file to include the necessary labels:
    ...
    ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2028/images/image-3.png?raw=true)
...
3. Use the modified values file to upgrade the chart:
   ...
   ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2028/images/image-4.png?raw=true)
...
4. Verify the updated configuration:
   ...
   ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2028/images/image-5.png?raw=true)
...
4. Confirm successful creation with:
   ...
   ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2028/images/image-6.png?raw=true)
...
4. Create a load balancer in Pordhi using the `eth0` IP and `NodePort` for the prometheus service. Access the Prometheus dashboard by visiting the load balancer url.
    ...
    ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2028/images/image-7.png?raw=true)

    Goto *Status* tab to see the detailed configuration where you will see the `webhook` config as well. 


    ![alt text](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2028/images/image-8.png?raw=true)  
