...
![](https://raw.githubusercontent.com/mehedih11/poridhi-labsx/8c32776fbb1632b6a28a9f935e66b2a5ddaad2eb/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2005/images/lab-5-logo.svg)
...
![](https://raw.githubusercontent.com/mehedih11/poridhi-labsx/8c32776fbb1632b6a28a9f935e66b2a5ddaad2eb/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2005/images/lab-5-infra.svg)
...
1. **Configure AWS CLI**:
   ...
   aws configure
   ```
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2005/images/lab-51.png?raw=true)
...
4. **Deploy the Terraform Infrastructure**:
   ...
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2005/images/lab-53.png?raw=true)
...
1. **Create Installation Scripts**:
   ...
   - Save this script and run it:
    ...
    ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2005/images/lab-55.png?raw=true)
...
2. **Create `exporter.sh` to Install Node Exporter on EC2 Instance**:
   ...
   `ssh` into the EC2 instance.
    ...
    terraform output
    ```
    ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2005/images/lab-510.png?raw=true)
   ...
   **Create `exporter.sh` script**:
   ...
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2005/images/lab-54.png?raw=true)
...
1. **Update Prometheus Configuration File**:
   ...
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2005/images/lab-56.png?raw=true)
...
2. **Validate Prometheus Configuration**:
   ...
   ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2005/images/lab-57.png?raw=true)
...
4. **Verify Node Exporter Metrics in Prometheus GUI**
   ...
   - Go to Poridhi's `LoadBalancer`and Create a `LoadBalancer` with the `eht0` IP and port `9090`.
    ...
    -  Click on the **"Status"** tab in the top menu and select **"Targets"** in Prometheus GUI.
       ...
       ![](https://github.com/mehedih11/poridhi-labsx/blob/main/Poridhi%20Labs/Observability%20and%20Monitoring/Prometheus%20Labs/Lab%2005/images/lab-58.png?raw=true)
